     ...
     textbooks: [
       {
         version: '人教版',
         chapters: [
           { id: 'pe-ch-ball', name: '球类运动', points: [ { id: 'pe-basketball-shot', name: '…', keywords: ['…'] } ] },
         ],
       },
     ],
...
export const PE_TREE: KnowledgeTree = {
  subject: 'pe',
  textbooks: [],
}
