     ...
     textbooks: [
       {
         version: '人美版',
         chapters: [
           { id: 'art-ch-painting', name: '绘画', points: [ { id: 'art-perspective', name: '…', keywords: ['…'] } ] },
         ],
       },
     ],
...
export const ART_TREE: KnowledgeTree = {
  subject: 'art',
  textbooks: [],
}
