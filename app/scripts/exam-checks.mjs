...
globalThis.__VITE_ENV__ = {
  VITE_SUPABASE_URL: 'http://127.0.0.1:5199',
...
import.meta.env.VITE_SUPABASE_URL = 'http://127.0.0.1:5199'
...
globalThis.location = { hostname: '127.0.0.1', origin: 'http://127.0.0.1:5199' }
